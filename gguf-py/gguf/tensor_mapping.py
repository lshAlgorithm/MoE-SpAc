...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.FFN_PREFETCH_GATE_EXP: (
            "model.prefetch.gate_proj.weight",
        ),
        MODEL_TENSOR.FFN_PREFETCH_DOWN_EXP: (
            "model.prefetch.down_proj.weight",
        ),
        MODEL_TENSOR.FFN_PREFETCH_UP_EXP: (
            "model.prefetch.up_proj.weight",
        ),
    }
    ...
    def __init__(self, arch: MODEL_ARCH, n_blocks: int):
        ...
        self.mapping.update({ \
            'model.prefetch.down_proj.weight':  (MODEL_TENSOR.FFN_PREFETCH_DOWN_EXP,    'model.prefetch.down_proj.weight'  ), \
            'model.prefetch.up_proj.weight':    (MODEL_TENSOR.FFN_PREFETCH_UP_EXP,      'model.prefetch.up_proj.weight'    ), \
            'model.prefetch.gate_proj.weight':  (MODEL_TENSOR.FFN_PREFETCH_GATE_EXP,    'model.prefetch.gate_proj.weight'  ), \
        })
