...
class MODEL_TENSOR(IntEnum):
    ...
    FFN_DOWN_EXP         = auto()
    FFN_UP_EXP           = auto()
    FFN_PREFETCH_GATE_EXP= auto()
    FFN_PREFETCH_DOWN_EXP= auto()
    FFN_PREFETCH_UP_EXP  = auto()
    FFN_GATE_SHEXP       = auto()
    FFN_DOWN_SHEXP       = auto()
    FFN_UP_SHEXP         = auto()
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    MODEL_TENSOR.FFN_PREFETCH_GATE_EXP:     "prefetch_gate_wgt",              # id connection between GGUF & GGML
    MODEL_TENSOR.FFN_PREFETCH_DOWN_EXP:     "prefetch_down_wgt",
    MODEL_TENSOR.FFN_PREFETCH_UP_EXP:       "prefetch_up_wgt",
